...
if not WEBUI_AUTH:
    app.state.config.ENABLE_SIGNUP = False
    app.state.config.ENABLE_LOGIN_FORM = False
...
app.state.config.ENABLE_COMMUNITY_SHARING = False
...
async def generate_messages(
    ...
    All models configured in 职鉴 are accessible via this endpoint.
...
async def get_current_usage(user=Depends(get_verified_user)):
    """
    Get current usage statistics for 职鉴.
