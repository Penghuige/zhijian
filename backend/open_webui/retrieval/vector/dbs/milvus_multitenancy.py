...
# can't be a legitimate 职鉴 collection name.
...
class MilvusClient(VectorDBBase):
    ...
    def _get_collection_and_resource_id(self, collection_name: str) -> Tuple[str, str]:
        ...
        WARNING: This mapping relies on current 职鉴 naming conventions for
        collection names. If 职鉴 changes how it generates collection names
